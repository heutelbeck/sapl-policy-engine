...
public class TargetExpressionCompiler {
    ...
    private static final String ERROR_TARGET_RELATIVE_ACCESSOR = "The targetexpression expression contains a top-level relative value accessor (@ or #) outside of any expression that may set its value.";
    private static final String ERROR_TARGET_STATIC_ERROR      = "The targetexpression expression statically evaluates to an error: %s.";
