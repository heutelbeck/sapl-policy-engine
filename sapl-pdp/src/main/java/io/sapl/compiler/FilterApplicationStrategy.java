...
class FilterApplicationStrategy {
     ...
     *
     * @param astNode the AST node for error reporting
     ...
     */
    public CompiledExpression applyFilterToValue(ParserRuleContext astNode, Value targetValue,
     ...
     */
    public CompiledExpression applyFilterToArrayElements(ParserRuleContext astNode, ArrayValue arrayValue,
     ...
     * @return the filtered array
     */
    public CompiledExpression applyFilterToAllArrayElements(ParserRuleContext astNode, ArrayValue arrayValue,
            String functionIdentifier, CompiledArguments arguments, CompilationContext context) {
     ...
     */
    public CompiledExpression applyFilterToObjectFields(ParserRuleContext astNode, ObjectValue objectValue,
     ...
     * @return the filtered object
     */
    public CompiledExpression applyFilterToAllObjectFields(ParserRuleContext astNode, ObjectValue objectValue,
            String functionIdentifier, CompiledArguments arguments, CompilationContext context) {
        return applyFilterToObjectFields(astNode, objectValue, key -> true, functionIdentifier, arguments, context);
    }

    // =========================================================================
    // VALUE filter implementations (Nature.VALUE) - compile-time constant folding
    // =========================================================================
     ...
     */
    private CompiledExpression applyValueFilterToArrayElements(ParserRuleContext astNode, ArrayValue arrayValue,
            IntPredicate indexMatcher, String functionIdentifier, CompiledArguments arguments,
            CompilationContext context) {
     ...
     */
    private CompiledExpression applyValueFilterToObjectFields(ParserRuleContext astNode, ObjectValue objectValue,
            Predicate<String> keyMatcher, String functionIdentifier, CompiledArguments arguments,
            CompilationContext context) {
     ...
     */
    private CompiledExpression applyPureFilterToValue(ParserRuleContext astNode, Value targetValue,
     ...
     */
    private CompiledExpression applyPureFilterToArrayElements(ParserRuleContext astNode, ArrayValue arrayValue,
            IntPredicate indexMatcher, String functionIdentifier, CompiledArguments arguments) {
     ...
     */
    private CompiledExpression applyPureFilterToObjectFields(ParserRuleContext astNode, ObjectValue objectValue,
            Predicate<String> keyMatcher, String functionIdentifier, CompiledArguments arguments) {
