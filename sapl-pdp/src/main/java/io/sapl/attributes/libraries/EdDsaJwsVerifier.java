 ...
 * the JDK's native EdDSA {@link Signature}. Covers both Ed25519 and Ed448 (the
 * concrete curve is inferred from the public key), and adds no dependency.
 * <p>
 * Nimbus' {@code DefaultJWSVerifierFactory} only builds RSA/EC/HMAC verifiers
 * and its built-in EdDSA verifier requires Google Tink, so this fills the gap
 * for EdDSA public keys produced by {@link JWTEncodingDecodingUtils}.
 */
