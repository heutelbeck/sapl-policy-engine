...
/**
 * N-ary exclusive disjunction (XOR, ^) for 3+ operands.
...
public record ExclusiveDisjunction(@NonNull List<Expression> operands, @NonNull SourceLocation location)
    ...
    private static final String ERROR_REQUIRES_AT_LEAST_3_OPERANDS = "ExclusiveDisjunction requires at least 3 operands, use BinaryOperator for 2";
