...
class FilterFunctionLibraryTests {
    ...
    void blackenNoArgumentsThrowsException() {
        assertThatThrownBy(FilterFunctionLibrary::blacken).isInstanceOf(IllegalArgumentException.class)
    ...
    void blackenNonStringTextThrowsException() {
        ...
        assertThatThrownBy(() -> FilterFunctionLibrary.blacken(nonStringValue))
    ...
    void blackenTooManyArgumentsThrowsException() {
        var params = new Value[] { Value.of("test"), Value.of(2), Value.of(2), Value.of("*"), Value.of(2),
                Value.of(2) };
        assertThatThrownBy(() -> FilterFunctionLibrary.blacken(params)).isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Illegal number");
    }
    ...
    void blackenNegativeDiscloseLeftThrowsException() {
        ...
        assertThatThrownBy(() -> FilterFunctionLibrary.blacken(text, negativeDisclosure))
    ...
    void blackenNegativeDiscloseRightThrowsException() {
        ...
        assertThatThrownBy(() -> FilterFunctionLibrary.blacken(text, discloseLeft, negativeDiscloseRight))
    ...
    void blackenNonStringReplacementThrowsException() {
        ...
        assertThatThrownBy(() -> FilterFunctionLibrary.blacken(text, discloseLeft, discloseRight, nonStringReplacement))
                .isInstanceOf(IllegalArgumentException.class).hasMessageContaining("REPLACEMENT");
    }
    ...
    void blackenNegativeLengthThrowsException() {
        ...
        assertThatThrownBy(
                () -> FilterFunctionLibrary.blacken(text, discloseLeft, discloseRight, replacement, negativeLength))
    ...
    void blackenNonNumericLengthThrowsException() {
        ...
        assertThatThrownBy(
                () -> FilterFunctionLibrary.blacken(text, discloseLeft, discloseRight, replacement, nonNumericLength))
                .isInstanceOf(IllegalArgumentException.class).hasMessageContaining("BLACKEN_LENGTH");
    }
    ...
    void blackenVariousInputsRedactsCorrectly(String text, int discloseLeft, int discloseRight, String replacement,
            String expected) {
        val result = FilterFunctionLibrary.blacken(Value.of(text), Value.of(discloseLeft), Value.of(discloseRight),
    ...
    void blackenWithLengthOverrideRedactsWithCustomLength(String text, int discloseLeft, int discloseRight,
        ...
        val result = FilterFunctionLibrary.blacken(Value.of(text), Value.of(discloseLeft), Value.of(discloseRight),
                Value.of("*"), Value.of(blackenLength));
    ...
    void blackenFullyDisclosedReturnsOriginal() {
        val result = FilterFunctionLibrary.blacken(Value.of("Shub-Niggurath"), Value.of(7), Value.of(7), Value.of("*"));
    ...
    void blackenFullyBlackenedReplacesAll() {
        val result = FilterFunctionLibrary.blacken(Value.of("Yog-Sothoth"), Value.of(0), Value.of(0), Value.of("#"));
    ...
    void blackenMultiCharacterReplacementRepeatsReplacement() {
        val result = FilterFunctionLibrary.blacken(Value.of("Nyarlathotep"), Value.of(4), Value.of(4),
                Value.of("[REDACTED]"));
    ...
    void blackenUnicodeCharactersHandlesCorrectly() {
        val result = FilterFunctionLibrary.blacken(Value.of("古のもの"), Value.of(1), Value.of(1), Value.of("█"));
    ...
    void blackenEmptyReplacementWithZeroLengthPreservesEnds() {
        val result = FilterFunctionLibrary.blacken(Value.of("Nyarlathotep"), Value.of(4), Value.of(4), Value.of(""),
                Value.of(0));
    ...
    void blackenEmptyStringReturnsEmpty() {
        val result = FilterFunctionLibrary.blacken(Value.of(""));
    ...
    void blackenSingleCharacterBlackensCorrectly() {
        val result = FilterFunctionLibrary.blacken(Value.of("R"), Value.of(0), Value.of(0));
    ...
    void blackenSingleCharacterFullyDisclosedReturnsOriginal() {
        val result = FilterFunctionLibrary.blacken(Value.of("R"), Value.of(1), Value.of(0));
    ...
    void blackenLongIncantationRedactsLargeText() {
        ...
        val result = FilterFunctionLibrary.blacken(Value.of(incantation), discloseLeft, discloseRight, replacement);
    ...
    void blackenVeryLongTextHandlesCorrectly() {
        ...
        val result          = FilterFunctionLibrary.blacken(Value.of(longIncantation), Value.of(10), Value.of(10));
    ...
    void replaceNormalValueReturnsReplacement() {
        val result = FilterFunctionLibrary.replace(Value.NULL, Value.of(13));
    ...
    void replaceErrorValuePreservesError() {
        ...
        val result = FilterFunctionLibrary.replace(error, Value.of("Safe"));
    ...
    void replaceUndefinedValueReturnsReplacement() {
        val result = FilterFunctionLibrary.replace(Value.UNDEFINED, Value.of("replacement"));
    ...
    void removeAnyValueReturnsUndefined() {
        val result = FilterFunctionLibrary.remove(Value.of("Elder Sign"));
    ...
    void removeNullValueReturnsUndefined() {
        val result = FilterFunctionLibrary.remove(Value.NULL);
    ...
    @Test
    void blackenWhenLengthExceedsMaximumThenThrows() {
        val parameters = new Value[] { Value.of("secret"), Value.of(0), Value.of(0), Value.of("X"),
                Value.of(1_000_000) };
