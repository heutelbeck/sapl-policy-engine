...
/**
 * End-to-end tests for the DelegatingReactivePolicyDecisionPoint. These tests
 * set up a
...
class DelegatingReactivePolicyDecisionPointTests {
    ...
    void whenStreamSubscribedAndCancelledThenLifecycleCallbacksFire() {
        ...
        val interceptedPdp = ReactivePolicyDecisionPointBuilder.from(components).pdp();
