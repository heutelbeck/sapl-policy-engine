...
public enum LibraryType {
     ...
     * Functions are invoked using the syntax {@code namespace.functionName(args)}.
     */
    FUNCTION_LIBRARY,

    /**
     * A Policy Information Point provides attribute finders that retrieve external
     * data during policy evaluation. Attributes are accessed using the syntax
     * {@code <namespace.attributeName>} for environment attributes or
