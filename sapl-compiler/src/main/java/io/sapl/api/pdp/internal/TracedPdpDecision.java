...
public class TracedPdpDecision {
    ...
    public static final class Builder {
        ...
        public Value build() {
            ...
            return ObjectValue.builder().put(TraceFields.DECISION, Value.of(decision.name()))
                    .put(TraceFields.OBLIGATIONS, obligations).put(TraceFields.ADVICE, advice)
                    .put(TraceFields.RESOURCE, resource).put(TraceFields.TRACE, traceBuilder.build()).build();
        }
        ...
        private Value convertSubscription(AuthorizationSubscription sub) {
            ...
            return ObjectValue.builder().put(SUBJECT, sub.subject()).put(ACTION, sub.action())
                    .put(RESOURCE_EL, sub.resource()).put(ENVIRONMENT, sub.environment()).build();
        }
    }
