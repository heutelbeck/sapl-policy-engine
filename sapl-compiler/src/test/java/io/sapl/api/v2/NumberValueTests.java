...
class NumberValueTests {
    ...
    void constructorNullValueThrows() {
        assertThatThrownBy(() -> new NumberValue(null, false))
    ...
    void factoryDoubleInfinityThrows(double value) {
        assertThatThrownBy(() -> Value.of(value))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void patternMatchingExtractsValue() {
        ...
        var result = switch (accessLevel) {
            ...
            case NumberValue(BigDecimal level, boolean ignore) when level.compareTo(BigDecimal.ZERO) > 0 ->
                    "Standard clearance";
            case NumberValue ignore -> "No clearance";
            default -> "Invalid";
        };
    ...
    static Stream<Arguments> provideNumberCombinations() {
        return Stream.of(
                ...
                Arguments.of(new BigDecimal("3.14"), false),
    ...
    static Stream<Arguments> provideNumericallyEqualPairs() {
        return Stream.of(
                Arguments.of(new BigDecimal("1"), new BigDecimal("1.0")),
    ...
    static Stream<Arguments> provideToStringCases() {
        return Stream.of(
                Arguments.of(new BigDecimal("3.14"), false, "3.14"),
                Arguments.of(BigDecimal.TEN, true, "***SECRET***"),
                Arguments.of(BigDecimal.ZERO, false, "0"),
    ...
    static Stream<Arguments> provideConstantCases() {
        return Stream.of(
                Arguments.of("Value.ZERO is not secret", Value.ZERO, false),
    ...
    void allZerosHashIdentically(int scale) {
        ...
        assertThat(zero1.hashCode())
                .isEqualTo(zero2.hashCode())
                .isEqualTo(zero3.hashCode());
    }
    ...
    void commonValuesHaveDistinctHashes() {
        ...
        var hashes = values.stream()
                .map(NumberValue::hashCode)
                .distinct()
                .count();
    ...
    static Stream<Arguments> provideExtremeScales() {
        return Stream.of(
                Arguments.of(
                        ...
                        "MIN scale: 1E-2147483647"
                ),
                Arguments.of(
                        new BigDecimal(BigInteger.valueOf(123), Integer.MAX_VALUE - 1),
                        "Near MIN scale: 123E-2147483646"
                ),
                Arguments.of(
                        new BigDecimal(BigInteger.ONE, Integer.MIN_VALUE),
                        "MAX scale: 1E+2147483648"
                ),
                Arguments.of(
                        new BigDecimal(BigInteger.TEN, Integer.MIN_VALUE + 1),
                        "Near MAX scale: 10E+2147483647"
                ),
                Arguments.of(
                        new BigDecimal(BigInteger.valueOf(100), Integer.MAX_VALUE / 2),
    ...
    static Stream<Arguments> providePowersOfTen() {
        return Stream.of(
                Arguments.of("10", "1E1"),
                Arguments.of("100", "1E2"),
                Arguments.of("1000", "1E3"),
                Arguments.of("0.1", "1E-1"),
                Arguments.of("0.01", "1E-2"),
                Arguments.of("0.001", "1E-3")
        );
    }
