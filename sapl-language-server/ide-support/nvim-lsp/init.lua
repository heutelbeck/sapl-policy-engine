--[[
    SAPL Language Server - Neovim Integration Example

    Copyright (C) 2017-2025 Dominic Heutelbeck (dominic@heutelbeck.com)
    SPDX-License-Identifier: Apache-2.0

    Reference configuration demonstrating SAPL LSP integration.
    Extract what you need for your own setup.
]]

-- Disable vim syntax highlighting for SAPL files.
