...
/**
 * Consumes directory watch events emitted by the {@link DirectoryWatcher} and
 * is called when the watch service has completed or when the watched directory is
...
public interface DirectoryWatchEventConsumer<T> {
    ...
    /**
     * Called upon each watch event emitted by the directory watch service registered
     * to the policy directory.
     *
