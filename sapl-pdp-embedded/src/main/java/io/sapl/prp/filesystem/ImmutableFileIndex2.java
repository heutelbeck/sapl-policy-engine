...
class ImmutableFileIndex2 {
    ...
    public ImmutableFileIndex2(String watchDir, SAPLInterpreter interpreter) {
    ...
    private ImmutableFileIndex2(ImmutableFileIndex2 oldIndex) {
    ...
    public ImmutableFileIndex2 afterFileEvent(FileEvent event) {
        var fileName = event.file().getName();
        var path     = event.file().toPath().toAbsolutePath();
        var newIndex = new ImmutableFileIndex2(this);
    ...
    public boolean becameConsistentComparedTo(ImmutableFileIndex2 idx) {
        return idx.isInconsistent() && isConsistent();
    }

    public boolean becameInconsistentComparedTo(ImmutableFileIndex2 idx) {
