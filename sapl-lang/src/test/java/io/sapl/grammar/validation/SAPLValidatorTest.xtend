...
class SAPLValidatorTest {
	...
	def void targetWithLazyAnd() {
		'''
			policy "test policy" permit a == b && c == d | e > f
		'''.parse.assertError(SaplPackage::eINSTANCE.and, null,
	...
	def void targetWithLazyOr() {
		'''
			policy "test policy" permit a == b & c == d || e > f
		'''.parse.assertError(SaplPackage::eINSTANCE.or, null,
	...
	def void targetWithAttributeFinderStep() {
		...
		'''.parse.assertError(SaplPackage::eINSTANCE.attributeFinderStep, null,
