...
class EquivalenceAndHashUtilTest {
    ...
    void testAreEquivalent() throws Exception {
        ...
        assertThat(EquivalenceAndHashUtil.areEquivalent(exp1, Collections.emptyMap(), exp2, Collections.emptyMap()), is(true));
        assertThat(EquivalenceAndHashUtil.areEquivalent(exp1, Collections.emptyMap(), exp3, Collections.emptyMap()), is(false));
        assertThat(EquivalenceAndHashUtil.areEquivalent(ent1, Collections.emptyMap(), ent1, Collections.emptyMap()), is(true));
        assertThat(EquivalenceAndHashUtil.areEquivalent(ent1, Collections.emptyMap(), ent2, Collections.emptyMap()), is(false));
        assertThat(EquivalenceAndHashUtil.areEquivalent(exp1, Collections.emptyMap(), ent1, Collections.emptyMap()), is(false));
