...
class JWTKeyProviderTests {
    ...
    @Test
    void provide_cacheThenRetrieve_shouldBeFalseThenTrueThenPublicKey() throws JWTKeyProvider.CachingException {
        final var pubKey     = (RSAPublicKey) keyPair.getPublic();
    ...
    void isCachedAndProvide_multipleKeys_shouldBeTwiceFalseThenPublicKeyThenTrueThenFalseThenPublicKeyTheTwiceTrueThenFalse()
            throws JWTKeyProvider.CachingException {
    ...
    @Test
    void provide_withUriEnvironmentMissingUri_shouldBeEmpty() throws JWTKeyProvider.CachingException {
    ...
    void provide_withUriEnvironmentAndInvalidCachingTTL_usingBase64Url_shouldThrowCachingException() {
        ...
        assertThrows(JWTKeyProvider.CachingException.class, () -> provider.provide(kid, serverNode));
    }

    @ParameterizedTest
    @MethodSource("provideWithUriEnvironmentSource")
    void provide_withUriEnvironment_usingBase64Url_shouldBePublicKey(String method)
            throws JWTKeyProvider.CachingException {
        dispatcher.setDispatchMode(DispatchMode.TRUE);
    ...
    @Test
    void provide_withUriAndCustomTTLEnvironment_usingBase64Url_shouldBePublicKey()
            throws JWTKeyProvider.CachingException {
        dispatcher.setDispatchMode(DispatchMode.TRUE);
    ...
    @Test
    void provide_withUriAndNegativeTTLEnvironment_usingBase64Url_shouldBePublicKey()
            throws JWTKeyProvider.CachingException {
        dispatcher.setDispatchMode(DispatchMode.TRUE);
        final var serverNode = JsonTestUtility.serverNode(server, null, -JWTTestUtility.TIME_UNIT);
        final var mono       = provider.provide(kid, serverNode);
    ...
    @Test
    void provide_withUriEnvironment_usingBase64Basic_shouldBePublicKey() throws JWTKeyProvider.CachingException {
    ...
    @Test
    void provide_withUriEnvironment_usingBase64Wrong_shouldBeEmpty() throws JWTKeyProvider.CachingException {
    ...
    @Test
    void provide_withUriEnvironment_usingBogusKey_shouldBeEmpty() throws JWTKeyProvider.CachingException {
    ...
    @Test
    void provide_withUriBogusEnvironment_shouldBeEmpty() throws JWTKeyProvider.CachingException {
