...
class TemporalFunctionLibraryTest {
    ...
    @Test
    void localToIsoTest() {
        assertThat(TemporalFunctionLibrary.localToIso(Val.of("2021-11-08T13:00:00")), is(val("2021-11-08T12:00:00Z")));
    }

    // @Test
    // void dinToIsoTest() {
    //     assertThat(TemporalFunctionLibrary.localToIso(Val.of("20.11.2021 13:00:00")), is(val("2021-11-20T12:00:00")));
    // }
    //
    // @Test
    // void dateInZoneTest() {
    //     assertThat(TemporalFunctionLibrary.dateInZone(Val.of("2021-11-08T13:00:00+05:00 Europe/Berlin")), is(val("2021-11-20T12:00:00")));
    // }

    @Test
    void dateAtOffsetTest() {
        assertThat(TemporalFunctionLibrary.dateAtOffset(Val.of("2021-11-08T13:12:35+05:00")), is(val("2021-11-08T08:12:35")));
    }

    @Test
    void localTimeAtOffsetTest() {
        assertThat(TemporalFunctionLibrary.localTimeAtOffset(Val.of("08:12:35"), Val.of("+02:00")), is(val("08:12:35")));
    }

    @Test
    void localTimeAtZoneTest() {
        assertThat(TemporalFunctionLibrary.localTimeAtZone(Val.of("08:12:35"), Val.of("Europe/Berlin")), is(val("08:12:35")));
    }

    @Test
    void timeAtOffsetTest() {
        assertThat(TemporalFunctionLibrary.timeAtOffset(Val.of("08:12:35"), Val.of("+05:00")), is(val("03:12:35")));
    }

    @Test
    void timeInZoneTest() {
        assertThat(TemporalFunctionLibrary.timeInZone(Val.of("08:12:35"), Val.of("Europe/Berlin")), is(val("07:12:35")));
    }

    // @Test
    // void timeAMPMTest() {
    //     assertThat(TemporalFunctionLibrary.timeAMPM(Val.of("08:12:35AM")), is(val("08:12:35")));
    //     assertThat(TemporalFunctionLibrary.timeAMPM(Val.of("08:12:35PM")), is(val("20:12:35")));
    // }
    ...
    void should_return_error_for_invalid_time_arguments() {
        ...
        assertThrowsForTwoArgs(TemporalFunctionLibrary::localTimeAtZone);
        assertThrowsForTwoArgs(TemporalFunctionLibrary::localTimeAtOffset);
