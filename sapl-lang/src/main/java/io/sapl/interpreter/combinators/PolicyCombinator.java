 ...
 * decision for the evaluation of multiple policies inside a policy set.
 */
public interface PolicyCombinator {

	/**
	 * Method which evaluates multiple SAPL policies against an authorization
	 * subscription object, combines the results and creates and returns a
	 * corresponding authorization decision object. The method is supposed to be
	 * used to determine an authorization decision for multiple policies inside a
	 * policy set.
	 * 
	 * @param policies the list of policies
	 * @param ctx      the evaluation context in which the given policies will be
