...
public class DigestFunctionLibrary {
    ...
    @Function(docs = """
            ...
            **Examples:**
            ...
            ```
            """, schema = RETURNS_TEXT)
    public static Val sha256(@Text Val data) {
        return computeDigest(data.getText(), "SHA-256");
    }
    ...
    @Function(docs = """
            ...
            **Examples:**
            ...
            ```
            """, schema = RETURNS_TEXT)
    public static Val sha384(@Text Val data) {
        return computeDigest(data.getText(), "SHA-384");
    }
    ...
    @Function(docs = """
            ...
            **Examples:**
            ...
            ```
            """, schema = RETURNS_TEXT)
    public static Val md5(@Text Val data) {
        return computeDigest(data.getText(), "MD5");
    }
    ...
    @Function(docs = """
            ...
            **Examples:**
            ...
            ```
            """, schema = RETURNS_TEXT)
    public static Val sha1(@Text Val data) {
        return computeDigest(data.getText(), "SHA-1");
    }
     ...
     * @return a Val containing the hexadecimal hash or an error
     */
    private static Val computeDigest(String data, String algorithm) {
        try {
            ...
            return Val.error(ERROR_ALGORITHM_NOT_AVAILABLE + algorithm + ".");
        }
    }
}
