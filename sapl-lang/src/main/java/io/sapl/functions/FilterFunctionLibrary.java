 ...
 * removing
 * sensitive data in authorization decisions. These transformations enable
 * fine-grained
 * access control where users receive modified versions of resources based on
 * their
 * authorization level, rather than simple permit/deny decisions.
 */
@UtilityClass
@FunctionLibrary(name = FilterFunctionLibrary.NAME, description = FilterFunctionLibrary.DESCRIPTION, libraryDocumentation = """
