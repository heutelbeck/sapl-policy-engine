...
class RsocketPDPControllerTests {
    ...
    final RSocketStrategies  rSocketStrategies = RSocketStrategies.builder().encoder(new JacksonJsonEncoder(MAPPER))
            .decoder(new JacksonJsonDecoder(MAPPER)).build();
    ...
    RSocketRequester createRSocketRequester() {
        val builder = RSocketRequester.builder().rsocketStrategies(rSocketStrategies);
    ...
    void subscribeToMultiDecisions() {
        ...
        val multiAuthzSubscription = new MultiAuthorizationSubscription()
