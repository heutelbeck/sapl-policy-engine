...
public class SchemaCompletionTests extends CompletionTests {
    ...
    @Test
    public void testCompletion_varContext() {
        testCompletion((TestCompletionConfiguration it) -> {
            String policy = "policy \"test\" permit where var foo = \"bar\"; schema ";
            //String cursor = "policy \"test\" permit where";
            it.setModel(policy);
            it.setColumn(policy.length());
            it.setAssertCompletionList(completionList -> {
                var expected = new ArrayList<String>();
    ...
    @Test
    public void testCompletion_getFromDir() {
        testCompletion((TestCompletionConfiguration it) -> {
            String policy = "schema \"test\" for  ";
            //String cursor = "policy \"test\" permit where";
            it.setModel(policy);
