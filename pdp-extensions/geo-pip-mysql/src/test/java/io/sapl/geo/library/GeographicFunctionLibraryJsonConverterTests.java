...
class GeographicFunctionLibraryJsonConverterTests extends TestBase {
    ...
    void geoJsonToKmlTest() throws TransformerException, ParseException {
        final var result       = GeographicFunctionLibrary.geoJsonToKml(point);
        final var result1      = GeographicFunctionLibrary.geoJsonToKml(polygon);
    ...
    void geoJsonToGMLTest() throws TransformerException, ParseException {
        final var result       = GeographicFunctionLibrary.geoJsonToGml(point);
        final var result1      = GeographicFunctionLibrary.geoJsonToGml(polygon);
    ...
    void geoJsonToWktTest() throws ParseException {
        final var result     = GeographicFunctionLibrary.geoJsonToWkt(point);
        final var result1    = GeographicFunctionLibrary.geoJsonToWkt(polygon);
