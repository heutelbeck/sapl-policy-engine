 ...
 * - `time.now().` - detects FUNCTION context with functionName="time.now"
 * - `subject.<pip.attr>.` - detects ATTRIBUTE context with
 * functionName="pip.attr"
 * - `|<pip.attr>.` - detects ENVIRONMENT_ATTRIBUTE context
 */
@UtilityClass
