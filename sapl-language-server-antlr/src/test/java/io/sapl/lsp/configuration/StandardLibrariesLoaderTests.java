...
class StandardLibrariesLoaderTests {
    ...
    void whenLoadingStandardConfiguration_thenAllLibrariesLoaded() {
        ...
        // Should have all 33 function libraries
        ...
        System.out.println("=== Function Libraries ===");
        for (var lib : bundle.functionLibraries()) {
            System.out.println("  " + lib.name() + " (" + lib.entries().size() + " functions)");
        }

        System.out.println("\n=== Policy Information Points ===");
        for (var pip : bundle.policyInformationPoints()) {
            System.out.println("  " + pip.name() + " (" + pip.entries().size() + " attributes)");
        }
    }
