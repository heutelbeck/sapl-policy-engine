...
/**
 * REST controller providing endpoints for a policy decision point.
...
public class PDPEndpointController {
	 ...
	 * @return a flux emitting authorization responses related to the individual
	 *         requests contained in the given {@code multiRequest} as soon as they are
	 *         available.
