...
/**
 * Default Implementation of {@link AbstractSaplCommandInterceptor}. It gets the
 * authentication from the {@link SecurityContextHolder}, converts it and
 * returns a Map, containing the subject.
 */

@RequiredArgsConstructor
public class DefaultSaplCommandInterceptor extends AbstractSaplCommandInterceptor {
