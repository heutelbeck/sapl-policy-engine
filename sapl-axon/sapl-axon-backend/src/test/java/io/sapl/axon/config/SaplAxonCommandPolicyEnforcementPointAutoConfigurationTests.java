...
public class SaplAxonCommandPolicyEnforcementPointAutoConfigurationTests {
	...
	void whenRan_thenMapperIsAvailableAndModulesAreRegistered() {
		...
		var contextRunner = new ApplicationContextRunner()
				.withConfiguration(AutoConfigurations.of(SaplAxonCommandPolicyEnforcementPointAutoConfiguration.class))
		...
		contextRunner.run(context -> {
			...
			assertThat(context).hasSingleBean(SaplAxonCommandPolicyEnforcementPointAutoConfiguration.class);
		});
	}
