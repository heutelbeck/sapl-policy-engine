...
/**
 * Policy Enforcement Point to authorize requests in the reactive Spring Security web
 * filter chain.
 * <p>
 * This {@link org.springframework.security.authorization.ReactiveAuthorizationManager}
 ...
 * </pre>
 *
 * The {@link #check check} method is then called by the Spring Security framework
 * whenever a request needs to be authorized.
 *
 * @param <T>
 * {@link org.springframework.security.web.server.authorization.AuthorizationContext}
 */
...
public class AuthorizationManagerPolicyEnforcementPoint<T extends AuthorizationContext>
	 ...
	 * <p>
	 * The incoming authentication is mapped to the decision of a Policy Decision Point
	 * (PDP). <br>
