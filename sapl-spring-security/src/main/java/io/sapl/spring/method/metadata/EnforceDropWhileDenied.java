...
/**
 * The @EnforceDropWhileDenied annotation establishes a reactive policy enforcement point
 ...
 * all events from the data stream wile the most recent decision is not PERMIT.
 *
