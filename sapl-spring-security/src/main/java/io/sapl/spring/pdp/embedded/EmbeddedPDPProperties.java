...
public class EmbeddedPDPProperties {
    ...
    /**
     * Indicate whether to load policies from the resources or the file
     * system.
     */
    public enum PDPDataSource {

        /**
         * Indicates to load static policies from the resources bundled in
         * the JAR.
         */
        RESOURCES,
        /**
         * Indicates to load policies dynamically from a monitored folder on
         * the file
         * system.
         */
        FILESYSTEM
