...
public class BlockingConstraintHandlerBundle<T> {
	...
	public static <T> BlockingConstraintHandlerBundle<T> postEnforceConstraintHandlerBundle(
			...
			UnaryOperator<T> onNextMapHandlers,
			Consumer<Throwable> doOnErrorHandlers,
			UnaryOperator<Throwable> onErrorMapHandlers,
			Predicate<Object> filterPredicateHandlers,
	...
	public static <T> BlockingConstraintHandlerBundle<T> preEnforceConstraintHandlerBundle(
			...
			UnaryOperator<Throwable> onErrorMapHandlers,
			Predicate<Object> filterPredicateHandlers,
			Consumer<MethodInvocation> methodInvocationHandlers,
			UnaryOperator<T> replaceResourceHandler) {
		return new BlockingConstraintHandlerBundle<>(onDecisionHandlers, methodInvocationHandlers,
				doOnNextHandlers, onNextMapHandlers, doOnErrorHandlers, onErrorMapHandlers, filterPredicateHandlers,
				replaceResourceHandler);
	}
