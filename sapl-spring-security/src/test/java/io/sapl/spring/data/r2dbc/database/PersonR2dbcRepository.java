 ...
 */
package io.sapl.spring.data.r2dbc.database;
...
public interface PersonR2dbcRepository extends R2dbcRepository<Person, Integer> {
    ...
    @QueryEnforce(subject = "#firstname", action = "general_protection_reactive_r2dbc_repository", resource = "T(io.sapl.spring.data.r2dbc.database.TestClass).setResource(#firstname, 'test value')", environment = "{\"testNode\":\"testValue\"}", staticClasses = {})
