...
class GeographicFunctionLibraryWktConverterTests extends TestBase {
    ...
    void wktToKmlTest() throws TransformerException, ParseException {
        final var result       = GeographicFunctionLibrary.wktToKml(point);
        final var result1      = GeographicFunctionLibrary.wktToKml(polygon);
    ...
    void wktToGMLTest() throws TransformerException, ParseException {
        final var result       = GeographicFunctionLibrary.wktToGml(point);
        final var result1      = GeographicFunctionLibrary.wktToGml(polygon);
    ...
    void wktToGeoJsonTest() throws ParseException, JsonProcessingException {
        final var result     = GeographicFunctionLibrary.wktToGeoJson(point);
        final var result1    = GeographicFunctionLibrary.wktToGeoJson(polygon);
