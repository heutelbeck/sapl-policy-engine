...
class GeographicFunctionLibraryKmlConverterTests extends TestBase {
    ...
    void kmlToGeoJsonTest() throws ParseException, JsonProcessingException {
        final var result     = GeographicFunctionLibrary.kmlToGeoJson(point);
        final var result1    = GeographicFunctionLibrary.kmlToGeoJson(polygon);
    ...
    void kmlToGMLTest() throws TransformerException, ParseException {
        final var res          = GeographicFunctionLibrary.kmlToGml(point);
        final var res1         = GeographicFunctionLibrary.kmlToGml(polygon);
    ...
    void kmlToWKTTest() throws ParseException {
        final var result     = GeographicFunctionLibrary.kmlToWkt(point);
        final var result1    = GeographicFunctionLibrary.kmlToWkt(polygon);
