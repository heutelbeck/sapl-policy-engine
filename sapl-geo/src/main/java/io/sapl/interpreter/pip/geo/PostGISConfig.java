...
public class PostGISConfig {
    ...
    private static final String SQL_PROJECTGEOM = "ST_AsText(ST_Transform(%s,%s))";
    private static final String SQL_GEOM = "ST_AsText(%s)";
	...
	if (verifySqlArguments()) {
	    return String.format(SQL_QUERY, getIdColName(), buildGeometryExpression(), getTable(),
		    buildConditions());
	} else {
