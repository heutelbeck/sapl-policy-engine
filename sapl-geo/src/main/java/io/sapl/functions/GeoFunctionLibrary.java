...
public class GeoFunctionLibrary {
	...
	// private static final String TOMETER_DOC = "toMeter(VALUE, UNIT): Converts the given
	...
	// public JsonNode toMeter(@Number JsonNode jsonValue, @Text JsonNode jsonUnit) throws
	// FunctionException {
	...
	// } else {
	// throw new FunctionException(String.format(UNIT_NOT_CONVERTIBLE, jsonUnit.asText(),
	// "m"));
	// }
	...
	// public JsonNode toSquareMeter(@Number JsonNode jsonValue, @Text JsonNode jsonUnit)
	// throws FunctionException {
	// double convertedValue;
	// Unit<? extends Quantity> unitFrom = Unit.valueOf(jsonUnit.asText());
	//
