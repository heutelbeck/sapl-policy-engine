...
public abstract class TrackerConnectionBase extends ConnectionBase {
	...
	protected Val createRequestTemplate(String baseUrl, String path, String mediaType, String[] headers,  String[] urlParameters,
			Long pollingInterval, Long repetitions) throws JsonProcessingException {
