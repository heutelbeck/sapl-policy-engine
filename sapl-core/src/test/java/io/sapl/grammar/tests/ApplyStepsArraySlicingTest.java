...
public class ApplyStepsArraySlicingTest {
	...
	public void fillNumberArray() {
		...
		for (int i = 0; i < 10; i++) {
			...
			list.add(new JsonNodeWithParentArray(
					Optional.of(JSON.numberNode(BigDecimal.valueOf(i))), numberArray, i));
		}
	...
	public void applySlicingToArrayNode() {
		List<AbstractAnnotatedJsonNode> list = new ArrayList<>();
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(1))), numberArray, 1));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(2))), numberArray, 2));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(3))), numberArray, 3));
		ResultNode expectedResult = new ArrayResultNode(list);

		applySlicingToArrayNode(1, 4, null).take(1)
				.subscribe(result -> assertEquals(
						"Slicing applied to array node should return corresponding items",
	...
	public void applySlicingToArrayNodeNegativeTo() {
		List<AbstractAnnotatedJsonNode> list = new ArrayList<>();
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(7))), numberArray, 7));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(8))), numberArray, 8));
		ResultNode expectedResult = new ArrayResultNode(list);

		applySlicingToArrayNode(7, -1, null).take(1).subscribe(result -> assertEquals(
	...
	public void applySlicingToArrayNodeNegativeFrom() {
		...
		applySlicingToArrayNode(-3, 9, null).take(1).subscribe(result -> assertEquals(
	...
	public void applySlicingToArrayWithFromGreaterThanTo() {
		...
		applySlicingToArrayNode(4, 1, null).take(1).subscribe(result -> assertEquals(
	...
	public void applySlicingToArrayNodeWithoutTo() {
		...
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(8))), numberArray, 8));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(9))), numberArray, 9));
		ResultNode expectedResult = new ArrayResultNode(list);

		applySlicingToArrayNode(7, null, null).take(1).subscribe(result -> assertEquals(
				"Slicing applied to array node without to to should return corresponding items",
				expectedResult, result));
	}
	...
	public void applySlicingToArrayNodeWithoutFrom() {
		List<AbstractAnnotatedJsonNode> list = new ArrayList<>();
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(0))), numberArray, 0));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(1))), numberArray, 1));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(2))), numberArray, 2));
		...
		applySlicingToArrayNode(null, 3, null).take(1).subscribe(result -> assertEquals(
				"Slicing applied to array node without from should return corresponding items",
				expectedResult, result));
	}
	...
	public void applySlicingToArrayNodeWithNegativeFrom() {
		...
		applySlicingToArrayNode(-3, null, null).take(1).subscribe(result -> assertEquals(
	...
	public void applySlicingToArrayNodeWithNegativeStep() {
		...
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(7))), numberArray, 7));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(6))), numberArray, 6));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(5))), numberArray, 5));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(4))), numberArray, 4));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(3))), numberArray, 3));
		list.add(new JsonNodeWithParentArray(
				Optional.of(JSON.numberNode(BigDecimal.valueOf(2))), numberArray, 2));
		...
		applySlicingToArrayNode(null, null, -1).take(1).subscribe(result -> assertEquals(
	...
	public void applySlicingToArrayNodeWithNegativeStepAndNegativeFrom() {
		...
		applySlicingToArrayNode(-2, 6, -1).take(1).subscribe(result -> assertEquals(
				"Slicing applied to array node with negative step from should return corresponding items",
				expectedResult, result));
	}
	...
	public void applySlicingToArrayNodeWithNegativeStepAndNegativeFromAndTo() {
		...
		applySlicingToArrayNode(-2, -5, -1).take(1).subscribe(result -> assertEquals(
				"Slicing applied to array node with negative step from should return corresponding items",
				expectedResult, result));
	}
	...
	private Flux<ResultNode> applySlicingToArrayNode(Integer from, Integer to,
			Integer step) {
