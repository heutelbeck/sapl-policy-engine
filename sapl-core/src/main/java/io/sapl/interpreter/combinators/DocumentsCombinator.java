 ...
 * of multiple SAPL documents.
 */
public interface DocumentsCombinator {

	/**
	 * Method which evaluates multiple SAPL documents (containing a policy set or a
	 * policy) against a Request object, combines the results and creates and returns a
	 * corresponding Response object. The method is supposed to be used to determine a
	 * response for the SAPL documents known to the PDP.
	 *
