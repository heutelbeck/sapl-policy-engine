...
public class DomainGenerator {
	...
	// return generateUnrestrictedPolicy(resources,
	// Collections.singletonList(DomainRoles.ROLE_SYSTEM));
	// }
	//
	// private DomainPolicy generateAdministratorPolicy(List<DomainResource>
	// resources) {
	...
	// StringBuilder policyBuilder = new
	// StringBuilder(adminPolicy.getPolicyContent());
	// addObligationToPolicy(policyBuilder, DomainUtil.LOG_OBLIGATION);
	//
	// return new DomainPolicy(adminPolicy.getPolicyName(),
	// policyBuilder.toString(), adminPolicy.getFileName());
	// }

	// private DomainPolicy generateUnrestrictedPolicy(List<DomainResource>
	// resources, List<DomainRole> roles) {
	...
	// DomainUtil.sanitizeFileName(fileName));
	// }

	// private DomainPolicy generateActionSpecificPolicy(List<DomainResource>
	// resources, List<String> actions,
	// List<DomainRole> roles) {
	// String policyName = String.format("%s can perform %s on %s",
	// DomainUtil.getRoleNames(roles), actions,
	...
	//
	//
	// return new DomainPolicy(policyName, generateBasePolicyWithActions(policyName,
	// resources, actions, roles)
	// .toString(), DomainUtil.sanitizeFileName(fileName));
	// }

	// private DomainPolicy
	// generateActionSpecificExtendedPolicy(List<DomainResource> resources,
	// List<String> actions,
	...
	//
	// StringBuilder policyBuilder = generateBasePolicyWithActions(policyName,
	// resources, actions,
	...
	// private void addBodyToPolicy(StringBuilder policyBuilder, DomainPolicyBody
	// body) {
	...
	// private void addAdviceToPolicy(StringBuilder policyBuilder,
	// DomainPolicyAdvice advice) {
	// policyBuilder.append(System.lineSeparator())
	// .append("advice").append(System.lineSeparator())
	// .append(TAB_STRING).append(advice.getAdvice());
	// }
	//
	// private void addTransformationToPolicy(StringBuilder policyBuilder,
	// DomainPolicyTransformation transformation) {
	// policyBuilder.append(System.lineSeparator())
	...
	// policies.add(new DomainPolicy(policyName, policyBuilder.toString(),
	// subjectName+ "_locked"));
	// }
	//
	// return policies;
