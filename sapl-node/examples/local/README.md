...
The jar is at `sapl-node/target/sapl-node-4.1.0.jar` (relative to the repository root).
...
java -jar ../../../target/sapl-node-4.1.0.jar
```
...
```bash
NODE_JAR=../../../target/sapl-node-4.1.0.jar
