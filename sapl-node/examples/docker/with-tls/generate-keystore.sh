...
DNAME="CN=localhost, OU=SAPL, O=Heutelbeck, L=Hagen, ST=NRW, C=DE"
VALIDITY_DAYS=365
...
echo
echo "The docker-compose.yml mounts ./tls into the container at /pdp/tls."
echo "Start the demo with: docker compose up"
