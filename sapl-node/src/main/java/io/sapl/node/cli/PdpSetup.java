 ...
 */
record PdpSetup(PolicyDecisionPoint pdp, JsonMapper mapper, ConfigurableApplicationContext context) {
     ...
     */
    static PdpSetup open(PdpOptions options, PrintWriter err) throws SSLException {
