...
class PolicySourceResolver {
    ...
    record ResolvedPolicy(PDPDataSource configType, String path, String publicKeyPath, boolean allowUnsigned) {}

    static ResolvedPolicy resolve(PolicySourceOptions policySource, BundleVerificationOptions bundleVerification,
