...
record BenchmarkResult(
    ...
    record Latency(double mean, double p50, double p90, double p99, double p999, double min, double max) {

        static Latency fromSamples(List<Double> nanoseconds) {
    ...
    static BenchmarkResult fromIterations(String method, int threads, List<Double> throughputs) {
