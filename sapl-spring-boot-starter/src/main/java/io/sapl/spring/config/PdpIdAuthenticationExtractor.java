 ...
 * tenant's PDP id. When registered as a Spring
 * bean, the SAPL auto-configuration creates a WebFilter that writes the
 * extracted id to the Reactor Context, where the
 * reactive tenant resolver picks it up.
 * <p>
