...
import io.sapl.spring.config.PdpIdAuthenticationExtractorBlocking;
 ...
 * {@link PolicyDecisionPoint#DEFAULT_PDP_ID} when no authentication or
...
public final class DefaultBlockingTenantResolver implements BlockingTenantResolver {
    ...
    public String resolve() {
        ...
        if (securityContext == null) {
            return PolicyDecisionPoint.DEFAULT_PDP_ID;
        }
        Authentication authentication = securityContext.getAuthentication();
        val            extracted      = extractor.extractPdpId(authentication);
        return extracted == null || extracted.isBlank() ? PolicyDecisionPoint.DEFAULT_PDP_ID : extracted;
    }
}
