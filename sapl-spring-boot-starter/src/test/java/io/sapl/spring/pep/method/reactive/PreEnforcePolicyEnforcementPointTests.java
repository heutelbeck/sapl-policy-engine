    ...
    static class TestConstraintHandlerProvider implements ConstraintHandlerProvider {
        ...
        public Optional<ScopedConstraintHandler> getConstraintHandler(Value constraint,
            ...
            case Obligation.SUBSCRIPTION_RUNNER          ->
                Optional.of(new ScopedConstraintHandler((Runner) logbook.subscriptionRuns::incrementAndGet,
                        SubscriptionSignal.TYPE, 0));
            case Obligation.CANCEL_RUNNER                -> Optional.of(
                    new ScopedConstraintHandler((Runner) logbook.cancelRuns::incrementAndGet, CancelSignal.TYPE, 0));
            case Obligation.COMPLETE_RUNNER              ->
                Optional.of(new ScopedConstraintHandler((Runner) logbook.completeRuns::incrementAndGet,
                        CompleteSignal.TYPE, 0));
            case Obligation.TERMINATE_RUNNER             ->
                Optional.of(new ScopedConstraintHandler((Runner) logbook.terminateRuns::incrementAndGet,
                        TerminationSignal.TYPE, 0));
            case Obligation.AFTER_TERMINATE_RUNNER       ->
                Optional.of(new ScopedConstraintHandler((Runner) logbook.afterTerminateRuns::incrementAndGet,
