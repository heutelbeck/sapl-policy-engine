 ...
 */
package io.sapl.spring.data.mongo.sapl.database;
...
public interface UserReactiveMongoRepository extends ReactiveMongoRepository<TestUser, ObjectId> {
    ...
    @QueryEnforce(subject = "#firstname", action = "general_protection_reactive_mongo_repository", resource = "T(io.sapl.spring.data.mongo.sapl.database.TestClass).setResource(#firstname, 'test value')", environment = "{\"testNode\":\"testValue\"}", staticClasses = {})
