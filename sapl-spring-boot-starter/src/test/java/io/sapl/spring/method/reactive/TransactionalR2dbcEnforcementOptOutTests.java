...
import io.sapl.spring.method.reactive.TransactionalR2dbcEnforcementOptOutTests.Application;
import io.sapl.spring.method.reactive.TransactionalR2dbcEnforcementOptOutTests.FailingMappingHandler;
import io.sapl.spring.method.reactive.TransactionalR2dbcEnforcementOptOutTests.R2dbcConfig;
import io.sapl.spring.method.reactive.TransactionalR2dbcEnforcementOptOutTests.ReactiveSecurityConfig;
import io.sapl.spring.method.reactive.TransactionalR2dbcEnforcementOptOutTests.TestService;
...
@SpringBootTest(classes = { Application.class, R2dbcConfig.class, ReactiveSecurityConfig.class, TestService.class,
        FailingMappingHandler.class }, properties = { "spring.main.web-application-type=none",
                "io.sapl.pdp.embedded.enabled=false", "spring.r2dbc.url=r2dbc:h2:mem:///optoutdb",
...
class TransactionalR2dbcEnforcementOptOutTests {
    ...
    @EnableR2dbcRepositories(basePackageClasses = TransactionalR2dbcEnforcementOptOutTests.class, considerNestedRepositories = true)
    ...
    @Test
    @WithMockUser
    @DisplayName("when transaction order adjustment disabled on reactive R2DBC then reactive pipeline still rolls back")
    void whenTransactionOrderAdjustmentDisabled_thenReactivePipelineStillRollsBack() {
