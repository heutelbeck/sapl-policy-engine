...
/**
 * This class implements a Vaadin component to provide a web-based and
 * JavaScript-powered editor for policies written in SAPL. It is instrumenting
 * Orion Code Edit as front-end and Xtext services to provide code assist and
