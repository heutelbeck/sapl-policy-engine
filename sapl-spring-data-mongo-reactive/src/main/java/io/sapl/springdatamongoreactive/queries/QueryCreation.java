...
public class QueryCreation {
	...
	private static <T extends Query> T addSelectionPart(ArrayNode selections, T query) {
	 ...
	 */
	public static <T> Query createManipulatedQuery(ArrayNode conditions, ArrayNode selections, String methodName,
			Class<T> domainType, Object[] args) {
