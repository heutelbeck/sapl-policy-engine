...
public class MongoReactiveRepositoryProxyPostProcessor<T> implements RepositoryProxyPostProcessor {
	...
	public void postProcess(ProxyFactory factory, RepositoryInformation repositoryInformation) {
		log.info("# MongoReactiveRepositoryProxyPostProcessor postProcess {} {}", factory.getClass().getSimpleName(),
	...
	private boolean hasRequiredInterface(Class<?> repository) {
		...
		for (Type interfaceType : interfaces) {
			if (interfaceType.equals(ReactiveCrudRepository.class) || interfaceType.equals(ReactiveMongoRepository.class) 
