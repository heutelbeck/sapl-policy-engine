...
class MongoReactiveRepositoryFactoryCustomizerTests {
    ...
    MongoReactiveRepositoryProxyPostProcessor<?> mongoReactiveRepositoryProxyPostProcessorMock = mock(MongoReactiveRepositoryProxyPostProcessor.class);
    ...
    void when_usingMongoEnforcementPointIsDesired_then_customizeRepositoryFactorySupport() {
        ...
        // THEN
        verify(repositoryFactorySupportMock, times(1)).addRepositoryProxyPostProcessor(mongoReactiveRepositoryProxyPostProcessorMock);
    }
