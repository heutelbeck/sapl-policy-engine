...
class MongoReactiveBeanPostProcessorTests {
    ...
    MongoReactiveRepositoryFactoryCustomizer mongoReactiveRepositoryFactoryCustomizerMock = mock(MongoReactiveRepositoryFactoryCustomizer.class);
    ...
    void when_postProcessBeforeInitialization_then_addRepositoryFactoryCustomizer() {
        // GIVEN
    	var mongoPostProcessor = new MongoReactiveBeanPostProcessor(mongoReactiveRepositoryFactoryCustomizerProviderMock);

        // WHEN
    	when(mongoReactiveRepositoryFactoryCustomizerProviderMock.getObject()).thenReturn(mongoReactiveRepositoryFactoryCustomizerMock);
        ...
        verify(reactiveMongoRepositoryFactoryBeanMock, times(1)).addRepositoryFactoryCustomizer(mongoReactiveRepositoryFactoryCustomizerMock);
    }
    ...
    void when_postProcessBeforeInitialization_then_findNoFittingBean() {
        ...
        verify(reactiveMongoRepositoryFactoryBeanMock, times(0)).addRepositoryFactoryCustomizer(mongoReactiveRepositoryFactoryCustomizerMock);
    }
}