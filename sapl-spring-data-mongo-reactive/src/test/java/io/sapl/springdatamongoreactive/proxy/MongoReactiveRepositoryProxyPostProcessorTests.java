...
class MongoReactiveRepositoryProxyPostProcessorTests {
	...
	RepositoryInformationCollectorService repositoryInformationCollectorServiceMock = mock(RepositoryInformationCollectorService.class);
	...
	UserReactiveMongoRepository mongoDbRepositoryTestMock = mock(UserReactiveMongoRepository.class);
