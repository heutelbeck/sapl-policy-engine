...
class SaplPartTreeCriteriaCreatorTests {
	...
	void when_create_then_createCriteriaDefinition3() {
		// GIVEN
		var manipulatedPartTree = new PartTree("findAllByAgeBeforeAndFirstnameLikeAndAdminIs", TestUser.class);
	...
	void when_create_then_createCriteriaDefinition4() {
		// GIVEN
		var manipulatedPartTree = new PartTree("findAllByAgeBeforeAndFirstnameLikeAndAdminIsOrFirstnameIs",
				TestUser.class);
