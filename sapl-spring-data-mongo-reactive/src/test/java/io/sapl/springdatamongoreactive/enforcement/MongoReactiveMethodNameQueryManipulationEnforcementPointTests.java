...
class MongoReactiveMethodNameQueryManipulationEnforcementPointTests {
	...
	void when_enforce_then_returnFluxDomainObject() {
		// GIVEN
		var enforcementPoint = new MongoReactiveMethodNameQueryManipulationEnforcementPoint<>(
	...
	void when_enforce_then_throwAccessDeniedException() {
		...
		queryCreationMock.verify(
				() -> QueryCreation.createManipulatedQuery(any(ArrayNode.class), any(ArrayNode.class),
						anyString(), eq(TestUser.class), any(Object[].class)),
				times(0));
