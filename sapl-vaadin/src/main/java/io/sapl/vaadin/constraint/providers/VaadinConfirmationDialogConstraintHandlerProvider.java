...
/**
 * This Constraint Handler Provider can be used to show a (custom) confirmation dialog based on SAPL Obligations.
 ...
 */
@Service
@ConditionalOnMissingClass(value = "com.vaadin.flow.component.confirmdialog.ConfirmDialog")
public class VaadinConfirmationDialogConstraintHandlerProvider implements VaadinFunctionConstraintHandlerProvider {
    ...
    public Function<UI, Mono<Boolean>> getHandler(JsonNode constraint) {
        ...
        return (UI ui) -> Mono.create(monoSink -> ui.access(() -> this.openConfirmDialog(header, text,
                confirmText, () -> monoSink.success(Boolean.TRUE),
                cancelText, () -> monoSink.success(Boolean.FALSE))));
    }

    void openConfirmDialog(String header, String text, String confirmText, Runnable confirmAction, String cancelText, Runnable cancelAction) {
        new VaadinConfirmationDialog(header, text,
