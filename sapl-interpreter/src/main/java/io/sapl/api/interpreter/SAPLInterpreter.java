...
public interface SAPLInterpreter {
	...
	/**
	 * Method which evaluates a String containing a SAPL document (containing a policy set
	 * or policy) against a Request object within a given attribute context and function
	...
	/**
	 * Method which evaluates the body of a SAPL document (containing a policy set or a
	 * policy) against a Request object within a given attribute context and function
	 * context and returns a {@link Flux} of {@link Response} objects.
	 * @param request the Request object
	 * @param saplDocument the SAPL document
	 * @param attributeCtx the attribute context
	 ...
	 * @return A {@link Flux} of {@link Response} objects.
	 */
	Flux<Response> evaluateRules(Request request, SAPL saplDocument,
			AttributeContext attributeCtx, FunctionContext functionCtx,
			Map<String, JsonNode> systemVariables);

	/**
	 * Method which evaluates a SAPL policy element (policy set or policy) against a
	 * Request object within a given AttributeContext and FunctionContext and returns a
	 * {@link Flux} of {@link Response} objects.. An import Map and custom variables can
	 * be provided.
	 * @param request the Request object
	 ...
	 * @param systemVariables the system variables, a Map between the variable name and
	 * its value
	 * @param variables the custom variables, a Map between the variable name and its
	 * value
	 * @param imports the imports Map, a Map between short names (String) and fully
	 * qualified names (String)
	 * @return A {@link Flux} of {@link Response} objects.
	 */
	Flux<Response> evaluateRules(Request request, PolicyElement policyElement,
			AttributeContext attributeCtx, FunctionContext functionCtx,
			Map<String, JsonNode> systemVariables, Map<String, JsonNode> variables,
			Map<String, String> imports);

	/**
	 * Method which checks whether a SAPL document matches a Request by evaluating the
	 ...
	 * @param saplDocument the SAPL document
	 * @param functionCtx the function context, as functions can be used in the target
	 * expression
	 ...
	 * @param request the Request to check against
	 * @param policyElement the policy element (policy set or policy) to be checked
	 * @param functionCtx the function context, as functions can be used in the target
	 * expression
	 * @param systemVariables the system variables
	 ...
	 * target expression
	 */
	boolean matches(Request request, PolicyElement policyElement,
