...
public class FirstApplicableTest {
	...
	public void permit() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" first-applicable" + " policy \"testp\" permit");
	...
	public void deny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" first-applicable" + " policy \"testp\" deny");
	...
	public void indeterminateTarget() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse(
				"set \"tests\" first-applicable" + " policy \"testp\" permit \"a\" < 5");
	...
	public void permitDeny() throws PolicyEvaluationException {
		...
		assertEquals("should return permit if the first policy evalautes to permit",
				Decision.PERMIT,
				INTERPRETER
						.evaluate(new Request(null, null, null, null), policySet,
								attributeCtx, functionCtx, SYSTEM_VARIABLES)
	...
	public void notApplicableDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" first-applicable"
				+ " policy \"testp1\" permit where false;"
				+ " policy \"testp2\" permit true == false" + " policy \"testp3\" deny");

		assertEquals(
				"should return deny if the first applicable policy evaluates to deny",
				Decision.DENY,
				INTERPRETER
						.evaluate(new Request(null, null, null, null), policySet,
								attributeCtx, functionCtx, SYSTEM_VARIABLES)
	...
	public void multiplePermitTransformation() throws PolicyEvaluationException {
		...
		assertEquals(
				"should return permit even if two matching policies have transformation",
				Decision.PERMIT,
				INTERPRETER
						.evaluate(new Request(null, null, null, null), policySet,
								attributeCtx, functionCtx, SYSTEM_VARIABLES)
	...
	public void permitTransformationResource() throws PolicyEvaluationException {
		...
		assertEquals(
				"should return resource if the first policy evaluated to permit has transformation",
	...
	public void collectObligationDeny() throws PolicyEvaluationException {
		...
		assertEquals("should collect obligation of first deny policy only",
	...
	public void collectAdviceDeny() throws PolicyEvaluationException {
		...
		assertEquals("should collect advice of first deny policy only",
				Optional.of(advice),
				INTERPRETER
						.evaluate(
								new Request(null, null,
	...
	public void collectObligationPermit() throws PolicyEvaluationException {
		...
		assertEquals("should collect obligation of first permit policy only",
				Optional.of(obligation),
				INTERPRETER
						.evaluate(
								new Request(null, null,
	...
	public void collectAdvicePermit() throws PolicyEvaluationException {
		...
		assertEquals("should collect advice of first permit policy only",
				Optional.of(advice),
				INTERPRETER
						.evaluate(
								new Request(null, null,
