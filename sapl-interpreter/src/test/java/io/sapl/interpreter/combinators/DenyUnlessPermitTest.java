...
public class DenyUnlessPermitTest {
	...
	public void permit() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit");
	...
	public void deny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" deny");
	...
	public void notApplicableTarget() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit true == false");
	...
	public void notApplicableCondition() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit where true == false;");
	...
	public void indeterminateTarget() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit \"a\" < 5");
	...
	public void indeterminateCondition() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit where \"a\" < 5;");
	...
	public void permitDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp1\" permit" + " policy \"testp2\" deny");
	...
	public void denyIndeterminate() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp1\" deny"
	...
	public void permitNotApplicableDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp1\" permit"
	...
	public void permitNotApplicableIndeterminateDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit" + " policy \"testp1\" deny \"a\" > 5"
	...
	public void singlePermitTransformation() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" deny-unless-permit"
				+ " policy \"testp1\" permit transform true" + " policy \"testp2\" deny");
	...
	public void singlePermitTransformationResource() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp\" permit transform true");
	...
	public void multiplePermitNoTransformation() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" deny-unless-permit" + " policy \"testp1\" permit" + " policy \"testp2\" permit");
