...
public class PermitUnlessDenyTest {
	...
	public void permit() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" permit");
	...
	public void deny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" deny");
	...
	public void notApplicableTarget() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" deny true == false");

		assertEquals("should return permit if the only policy target evaluates to not applicable", Decision.PERMIT,
	...
	public void notApplicableCondition() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" deny where true == false;");

		assertEquals("should return permit if the only policy condition evaluates to not applicable", Decision.PERMIT,
				INTERPRETER.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx,
						SYSTEM_VARIABLES).getDecision());
	}
	...
	public void indeterminateTarget() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" deny \"a\" < 5");

		assertEquals("should return permit if the only target is indeterminate", Decision.PERMIT, INTERPRETER
				.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx, SYSTEM_VARIABLES)
				.getDecision());
	}
	...
	public void indeterminateCondition() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" deny where \"a\" < 5;");

		assertEquals("should return deny if the only condition is indeterminate", Decision.PERMIT, INTERPRETER
				.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx, SYSTEM_VARIABLES)
				.getDecision());
	}
	...
	public void permitDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp1\" permit" + " policy \"testp2\" deny");
	...
	public void denyIndeterminate() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp1\" permit"
				+ " policy \"testp2\" permit where \"a\" > 5;");

		assertEquals("should return permit if policies evaluate to deny and indeterminate", Decision.PERMIT, INTERPRETER
				.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx, SYSTEM_VARIABLES)
				.getDecision());
	}
	...
	public void permitNotApplicableDeny() throws PolicyEvaluationException {
		...
		assertEquals("should return deny if any policy evaluates to permit", Decision.DENY, INTERPRETER
				.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx, SYSTEM_VARIABLES)
				.getDecision());
	}
	...
	public void permitNotApplicableIndeterminateDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny" + " policy \"testp1\" deny \"a\" > 5"
	...
	public void permitIndeterminateNotApplicable() throws PolicyEvaluationException {
		...
		assertEquals("should return permit if only indeterminate, permit and not applicable present", Decision.PERMIT,
				INTERPRETER.evaluate(new Request(null, null, null, null), policySet, attributeCtx, functionCtx,
						SYSTEM_VARIABLES).getDecision());
	}
	...
	public void singlePermitTransformation() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp1\" permit transform true");
	...
	public void singlePermitTransformationResource() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp\" permit transform true");
	...
	public void multiplePermitNoTransformation() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER
				.parse("set \"tests\" permit-unless-deny" + " policy \"testp1\" permit" + " policy \"testp2\" permit");
	...
	public void collectObligationDeny() throws PolicyEvaluationException {
		SAPL policySet = INTERPRETER.parse("set \"tests\" permit-unless-deny"
