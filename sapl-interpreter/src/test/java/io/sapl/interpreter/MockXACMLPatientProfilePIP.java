...
public class MockXACMLPatientProfilePIP {
	...
	@Attribute
	public Flux<JsonNode> profile(JsonNode value, Map<String, JsonNode> variables)
			throws IOException {
		String json = "{" + "	\"patient\": {" + "		\"name\": {"
				+ "			\"first\": \"Bartholomew\","
				+ "			\"last\": \"Simpson\"" + "		}," + "		\"contact\": {"
				+ "			\"street\": \"27 Shelbyville Road\","
				+ "			\"email\": null" + "		},"
				+ "		\"DoB\": \"1992-03-21\","
				+ "		\"patient_number\": \"555555\"" + "	}," + "	\"parentGuardian\": {"
				+ "		\"id\": \"HS001\"," + "		\"name\": {"
				+ "			\"first\": \"Homer\"," + "			\"last\": \"Simpson\""
				+ "		}," + "		\"contact\": {"
				+ "			\"email\": \"homers@aol.com\"" + "		}" + "	},"
				+ "	\"primaryCarePhysician\": {" + "		\"contact\": { },"
				+ "		\"registrationID\": \"ABC123\"" + "	}," + "	\"medical\": {"
				+ "		\"treatment\": {" + "			\"drug\": {"
