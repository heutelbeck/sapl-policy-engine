...
@DisplayName("SaplFlatBuffersCodec")
class SaplFlatBuffersCodecTests {
    ...
    class ValueSerializationTests {
        ...
        void shouldRoundTripValueTypes(String description, Value original) {
    ...
    class AuthorizationSubscriptionSerializationTests {
        ...
        void shouldRoundTripSubscriptionWithAllFields() {
            ...
            var bytes        = SaplFlatBuffersCodec.writeAuthorizationSubscription(subscription);
            var deserialized = SaplFlatBuffersCodec.readAuthorizationSubscription(bytes);
        ...
        void shouldRoundTripSubscriptionWithUndefinedFields() {
    ...
    class AuthorizationDecisionSerializationTests {
        ...
        void shouldRoundTripDecisions(String description, Decision decision) {
            var authDecision = new AuthorizationDecision(decision, Value.EMPTY_ARRAY, Value.EMPTY_ARRAY,
                    Value.UNDEFINED);

            var bytes        = SaplFlatBuffersCodec.writeAuthorizationDecision(authDecision);
            var deserialized = SaplFlatBuffersCodec.readAuthorizationDecision(bytes);
        ...
        void shouldRoundTripDecisionWithObligationsAndAdvice() {
    ...
    class MultiAuthorizationSubscriptionSerializationTests {
        ...
        void shouldRoundTripEmptyMultiSubscription() {
            var multi = new MultiAuthorizationSubscription();

            var bytes        = SaplFlatBuffersCodec.writeMultiAuthorizationSubscription(multi);
            var deserialized = SaplFlatBuffersCodec.readMultiAuthorizationSubscription(bytes);
        ...
        void shouldRoundTripMultiSubscriptionWithMultipleEntries() {
            var multi = new MultiAuthorizationSubscription();
    ...
    class MultiAuthorizationDecisionSerializationTests {
        ...
        void shouldRoundTripEmptyMultiDecision() {
            var multi = new MultiAuthorizationDecision();

            var bytes        = SaplFlatBuffersCodec.writeMultiAuthorizationDecision(multi);
            var deserialized = SaplFlatBuffersCodec.readMultiAuthorizationDecision(bytes);
        ...
        void shouldRoundTripMultiDecisionWithMultipleEntries() {
            var multi = new MultiAuthorizationDecision();
    ...
    class IdentifiableAuthorizationDecisionSerializationTests {
        ...
        void shouldRoundTripIdentifiableDecision() {
            ...
            var bytes        = SaplFlatBuffersCodec.writeIdentifiableAuthorizationDecision(idDec);
            var deserialized = SaplFlatBuffersCodec.readIdentifiableAuthorizationDecision(bytes);
