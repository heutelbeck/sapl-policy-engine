...
```bash
docker run -d -p 8080:8080 ghcr.io/heutelbeck/sapl-playground:4.1.1
```
...
docker run -d -p 8080:8080 \
  ...
  ghcr.io/heutelbeck/sapl-playground:4.1.1
```
...
services:
  sapl-playground:
    image: ghcr.io/heutelbeck/sapl-playground:4.1.1
    ports:
      - "8080:8080"
    environment:
