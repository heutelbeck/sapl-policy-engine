...
```bash
docker run -d -p 8080:8080 ghcr.io/heutelbeck/sapl-playground:4.1.2
```
...
docker run -d -p 8080:8080 \
  ...
  ghcr.io/heutelbeck/sapl-playground:4.1.2
```
...
services:
  sapl-playground:
    image: ghcr.io/heutelbeck/sapl-playground:4.1.2
    ports:
      - "8080:8080"
    environment:
