...
```bash
docker run -d -p 8080:8080 ghcr.io/heutelbeck/sapl-playground:4.0.0
```
...
docker run -d -p 8080:8080 \
  ...
  ghcr.io/heutelbeck/sapl-playground:4.0.0
```
...
services:
  sapl-playground:
    image: ghcr.io/heutelbeck/sapl-playground:4.0.0
    ports:
      - "8080:8080"
    environment:
