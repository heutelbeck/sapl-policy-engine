...
```bash
docker run -d -p 8080:8080 ghcr.io/heutelbeck/sapl-playground:4.1.0-SNAPSHOT
```
...
docker run -d -p 8080:8080 \
  ...
  ghcr.io/heutelbeck/sapl-playground:4.1.0-SNAPSHOT
```
...
services:
  sapl-playground:
    image: ghcr.io/heutelbeck/sapl-playground:4.1.0-SNAPSHOT
    ports:
      - "8080:8080"
    environment:
