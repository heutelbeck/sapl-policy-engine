...
/**
 * Performs policy enforcement and authorization logic before a method is invoked.
 */
public interface PreInvocationEnforcementAdvice extends AopInfrastructureBean {
	 ...
	 * decide whether the method call is authorized. Required obligations and available
	 * advices are executed.
	 ...
	 * @param preInvocationAttribute the attribute built from the @PreEnforce annotation.
