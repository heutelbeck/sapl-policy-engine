...
<vaadin-vertical-layout style="width: 100%; height: 100%; padding: var(--lumo-space-s);" theme="spacing-s">
 ...
 <vaadin-split-layout style="width: 100%; height: 100%;">
  ...
  <vaadin-vertical-layout id="showCurrentClientCredentialsLayout" style="width: 50%;">
   ...
   <vaadin-text-field label="Secret" id="secretTextField" style="width: 100%; flex-shrink: 1; margin: var(--lumo-space-s);" readonly value="*****" has-value></vaadin-text-field>
   <div style="font-weight:bold; color: red; flex-shrink: 1; width: 100%; margin: var(--lumo-space-s);" id="secretHintDiv">
    The shown secret will not be shown again and is non-recoverable. If the secret is lost, a new set of client credentials must be generated to regain access.
   </div>
