define("sapl-test-mode", ["codemirror", "codemirror/addon/mode/simple"], function(CodeMirror, SimpleMode) {
	var keywords = "with|whitespace|where|when|wait|virtual-time|variables|value|using|undefined|true|to|timing|times|then|text|test|subject|stream|starting|scenario|returns|return|resource|register|regex|policies|permit-unless-deny|permit-overrides|permit|pdp|parent|parameters|order|only-one-applicable|once|on|obligations|obligation|object|number|null-or-empty|null-or-blank|null|notApplicable|no-event|matching|library|let|length|key|is|indeterminate|in|identifier|given|function|for|false|expect|exception|error|equals|equal|environment|ending|empty|deny-unless-permit|deny-overrides|deny|decision|custom|containing|configuration|compressed|combining-algorithm|case-insensitive|called|boolean|blank|attribute|attempts|array|any|and|advice|action|TemporalFunctionLibrary|StandardFunctionLibrary|PIP|LoggingFunctionLibrary|FilterFunctionLibrary";
