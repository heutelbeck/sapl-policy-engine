...
- **[HTTP API](../6_1_HTTPApi/):** A network API for any programming language. Supports streaming (Server-Sent Events), one-shot (JSON), and multi-subscription endpoints.
- **[Java API](../6_2_JavaApi/):** A reactive API based on Project Reactor for embedding a PDP directly in Java applications or connecting to a remote PDP server.
