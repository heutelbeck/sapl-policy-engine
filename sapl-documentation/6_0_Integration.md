...
- **[Python FastMCP](../6_10_PythonFastMCP/):** Integrating SAPL authorization into FastMCP (Model Context Protocol) servers.
- **[.NET](../6_11_DotNet/):** Attribute-driven policy enforcement for ASP.NET Core applications.
