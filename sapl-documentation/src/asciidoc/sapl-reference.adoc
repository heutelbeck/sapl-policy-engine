...
== Deploying Custom Function Libraries and Attribute Finders
...
With the SAPL testframework you can test SAPL policies no matter if you use SAPL via a embedded PDP in your application or via a central SAPL server.
