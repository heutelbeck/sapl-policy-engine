...
| `keep-alive` | `long` | `15` | Seconds between SSE keep-alive frames on idle streaming connections. Prevents proxies and firewalls from dropping inactive connections. `0` disables keep-alive. See [Reverse Proxy Configuration](../7_6_Security/#reverse-proxy-configuration). |
