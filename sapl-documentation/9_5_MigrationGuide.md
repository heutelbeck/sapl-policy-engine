...
This section will document migration paths to SAPL 4.0.
...
- **XACML to SAPL:** Mapping XACML concepts to SAPL equivalents (cross-reference to [Combining Algorithm](../2_5_CombiningAlgorithms/) for algorithm mapping)
