...
public interface R2dbcPersonRepository
        extends R2dbcRepository<Person, String> {
    ...
    @QueryEnforce(subject = "#firstname", action = "general_protection_reactive_r2dbc_repository", resource = "T(io.sapl.springdatacommon.database.TestClass).setResource(#firstname, 'test value')", environment = "{\"testNode\":\"testValue\"}", staticClasses = {})
