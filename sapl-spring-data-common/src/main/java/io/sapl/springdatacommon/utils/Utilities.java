...
public class Utilities {
	...
	private static final Pattern DEFAULT_METHODS = Pattern
			.compile("^(find|read|get|query|search|stream)All$");
    ...
    public static boolean isMonoReturnType(Method method) {
        return Mono.class.isAssignableFrom(method.getReturnType());
    }

    public static boolean isFluxReturnType(Method method) {
