...
/**
 * Exception to indicate that the current attribute backend is currently not available.
 */
public class AttributeBackendUnavailableException extends RuntimeException {
