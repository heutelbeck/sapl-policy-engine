...
class R2dbcRepositoryFactoryCustomizerTests {
    ...
    R2dbcRepositoryProxyPostProcessor<?> R2dbcRepositoryProxyPostProcessorMock = mock(R2dbcRepositoryProxyPostProcessor.class);
    ...
    void when_usingMongoEnforcementPointIsDesired_then_customizeRepositoryFactorySupport() {
        ...
        // THEN
        verify(repositoryFactorySupportMock, times(1)).addRepositoryProxyPostProcessor(R2dbcRepositoryProxyPostProcessorMock);
    }
