...
class R2dbcBeanPostProcessorTests {
    ...
    R2dbcRepositoryFactoryCustomizer r2dbcRepositoryFactoryCustomizerMock = mock(R2dbcRepositoryFactoryCustomizer.class);
    ...
    void when_postProcessBeforeInitialization_then_addRepositoryFactoryCustomizer() {
        ...
        verify(R2dbcRepositoryFactoryBeanMock, times(1)).addRepositoryFactoryCustomizer(r2dbcRepositoryFactoryCustomizerMock);
    }
    ...
    void when_postProcessBeforeInitialization_then_findNoFittingBean() {
        ...
        verify(R2dbcRepositoryFactoryBeanMock, times(0)).addRepositoryFactoryCustomizer(r2dbcRepositoryFactoryCustomizerMock);
    }
}