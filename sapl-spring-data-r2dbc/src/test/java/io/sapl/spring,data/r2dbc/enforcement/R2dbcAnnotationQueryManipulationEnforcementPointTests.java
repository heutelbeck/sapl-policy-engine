...
class R2dbcAnnotationQueryManipulationEnforcementPointTests {
    ...
    QueryManipulationConstraintHandlerService queryManipulationConstraintHandlerServiceMock = mock(
    ...
    void beforeEach() throws URISyntaxException {
        ...
        when(queryManipulationConstraintHandlerServiceMock.getTransformations()).thenReturn(EMPTY_ARRAY_NODE);
        when(queryManipulationConstraintHandlerServiceMock.getAlias()).thenReturn("");
        when(queryManipulationConstraintHandlerServiceMock.getQueryManipulationObligations())
    ...
    void when_enforce_then_returnFluxDomainObject() {
        ...
        final var enforcementPoint              = new R2dbcAnnotationQueryManipulationEnforcementPoint<Person>(
        ...
        verify(queryManipulationConstraintHandlerServiceMock, times(1)).getConditions();
        verify(queryManipulationConstraintHandlerServiceMock, times(1)).getSelections();
        queryCreationMock.verify(() -> QueryCreation.manipulateQuery(anyString(), any(ArrayNode.class),
    ...
    void when_enforce_then_throwAccessDeniedException() {
        ...
        verify(constraintQueryEnforcementServiceMock, times(0))
                .queryManipulationForR2dbc(any(AuthorizationDecision.class));
        verify(queryManipulationConstraintHandlerServiceMock, times(0)).getConditions();
        verify(queryManipulationConstraintHandlerServiceMock, times(0)).getSelections();
        queryCreationMock.verify(() -> QueryCreation.manipulateQuery(anyString(), any(ArrayNode.class),
                any(ArrayNode.class), any(ArrayNode.class), anyString(), eq(Person.class)), times(0));
    ...
    private static PolicyDecisionPointBuilder.PDPComponents buildPdp() throws URISyntaxException {
        val policiesPath = Paths
                .get(Objects.requireNonNull(R2dbcAnnotationQueryManipulationEnforcementPointTests.class.getClassLoader()
