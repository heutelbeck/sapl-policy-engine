...
public class R2dbcMethodNameQueryManipulationEnforcementPoint<T> {
	 ...
	 *         query.
	 */
	private Flux<T> enforceQueryManipulation(ArrayNode conditions, ArrayNode selections, Class<T> domainType,
			String baseQuery) {
		var manipulatedCondition = QueryCreation.createSqlQuery(conditions, selections, domainType, baseQuery);
