...
class InputStreamHelperTests {
    ...
    void assertNoIllegalBidiUnicodeCharactersPresentInStreamCatchesIllegalCharacters() throws IOException {
        ...
        assertThrows(SaplParserException.class, () -> IOUtils.toString(invalidContainsLri, utf8));
        assertThrows(SaplParserException.class, () -> IOUtils.toString(invalidContainsPdi, utf8));
        assertThrows(SaplParserException.class, () -> IOUtils.toString(invalidContainsRli, utf8));
        assertThrows(SaplParserException.class, () -> IOUtils.toString(invalidContainsRlo, utf8));
    }
