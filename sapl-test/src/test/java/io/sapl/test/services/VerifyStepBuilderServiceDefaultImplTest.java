...
class VerifyStepBuilderServiceDefaultImplTest {

    private ExpectInterpreter expectInterpreterMock;

    private VerifyStepBuilderServiceDefaultImpl verifyStepBuilderServiceDefault;

    @BeforeEach
    void setUp() {
        expectInterpreterMock = mock(ExpectInterpreter.class);

        verifyStepBuilderServiceDefault = new VerifyStepBuilderServiceDefaultImpl(expectInterpreterMock);
    }
