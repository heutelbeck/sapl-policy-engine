...
class TestEventTests {

    @Test
    @DisplayName("ScenarioCompleted contains scenario result")
    void whenCreatingScenarioCompleted_thenResultIsAccessible() {
    ...
    @Test
    @DisplayName("ExecutionCompleted contains test results")
    void whenCreatingExecutionCompleted_thenResultsAreAccessible() {
        var scenarioResult = ScenarioResult.passed("doc", "req", "scenario", Duration.ofMillis(50), null);
