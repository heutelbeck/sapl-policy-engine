...
public final class DefaultStepConstructor implements StepConstructor {
    ...
    public static StepConstructor of(final UnitTestPolicyResolver customUnitTestPolicyResolver, final IntegrationTestPolicyResolver customIntegrationTestPolicyResolver) {
